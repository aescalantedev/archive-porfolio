...
export const Profile: React.FC = () => {
  ...
  return (
    <section className="border-b border-border-custom px-6 py-20 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 bg-bg-primary transition-all duration-300">
